...
A challenge I, for some reason, never considered to be a problem. I often leave work late due to fear of failing them or failing to understand them properly, so as a result I end up doing mediocre quality work and accept whatever the outcome is. In order to learn, failing is necessary and, more often than not, inevitable. To improve this, I'll link this challenge with the 2nd one (Organise my tasks and deadlines properly). The idea is; if I have a clear map of my assignments (in this case my calendar), it'll be easier to know ahead of time when I can or should work on a particular task, which will give me enough time to experiment and therefore improve. 
